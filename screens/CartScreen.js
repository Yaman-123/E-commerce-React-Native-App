...
const CartScreen = () => {
    ...
    const total = cart.map((item, index) => item.price * item.quantity).reduce((curr, prev) => curr + prev, 0)
    console.log(total)
    return (
        <ScrollView style={{ marginTop: 50, backgroundColor: "white" }}>
            ...
            <Pressable onPress={()=>navigation.navigate("confirmation")} style={{ backgroundColor: "#FFC72C", padding: 10, borderRadius: 5, justifyContent: "center", alignItems: "center", marginHorizontal: 10, marginTop: 10 }}>
            ...
            <View style={{ marginHorizontal: 10 }}>
                {
                    cart.map((item, index) => (
                        <View key={index} style={{ backgroundColor: "white", marginVertical: 10, borderBottomColor: "#F0F0F0", borderWidth: 2, borderLeftWidth: 0, borderRightWidth: 0, borderTopWidth: 0 }}>
                            ...
                            <Pressable style={{ marginTop: 15, marginBottom: 20, flexDirection: "row", alignItems: 'center', gap: 10 }}>
                                <View style={{ flexDirection: 'row', alignItems: 'center', paddingHorizontal: 10, paddingVertical: 10, borderRadius: 6 }}>

                                    {
                                        item.quantity > 1 ? (
                                            ...
                                            <Pressable onPress={()=>deleteQuantity(item)} style={{ backgroundColor: "#D8D8D8", padding: 7, borderTopLeftRadius: 6, borderBottomLeftRadius: 6 }}>
                                ...
                                <Pressable onPress={()=>deleteQuantity(item)} style={{ backgroundColor: "white", paddingHorizontal: 8, paddingVertical: 10, borderRadius: 5, borderColor: "#C0C0C0", borderWidth: 0.6 }}>
                                    <Text>Delete</Text>
                                </Pressable>
                            </Pressable>
